        ...
        <div>
                ...
                <Row align="middle" justify="space-between">
                    <Col>
                        <div className='upload-header'>
                            ...
                            <Typography.Title level={5}>{"Початкові дані про перехресне зв'язування: "}</Typography.Title>
                        </div>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <Button type="primary" icon={<UploadOutlined />}>{"Натисніть щоб завантажити файл"}</Button>
                            </Upload>
                        </div>
                    </Col>
                    <Col>
...

            {
                parseResult
                    ...
                    : <Empty description={<Typography.Title level={4}>{"Не завантажено жодного файлу"}</Typography.Title>} /> /*<Empty description={<Typography.Title level={4}>No uploaded file</Typography.Title>} />*/
            }
